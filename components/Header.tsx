        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-18 gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <button
                onClick={toggleTheme}
                className="p-2.5 text-gray-700 dark:text-gray-400 active:text-[#D4AF37] dark:active:text-[#D4AF37] active:bg-gray-100 dark:active:bg-[#1a1a1a] transition-colors rounded-lg touch-manipulation group"
