...
export function ProductCardSkeleton() {
  return (
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden animate-pulse">
      {/* Image skeleton */}
      <div className="relative aspect-square bg-gradient-to-br from-gray-100 to-gray-200"></div>
      {/* Content skeleton */}
...
export function CollectionBannerSkeleton() {
  return (
    <div className="relative w-full h-32 md:h-40 rounded-lg shadow-sm overflow-hidden bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 animate-pulse">
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="h-6 md:h-8 w-48 bg-white/40 rounded"></div>
      </div>
    </div>
  );
}
...
export function ReviewCardSkeleton() {
  return (
    <div className="bg-white rounded-lg p-3 md:p-4 shadow-sm border border-gray-100 min-w-[240px] max-w-[240px] animate-pulse">
