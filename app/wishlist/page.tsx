    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50/30 to-white">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="flex items-center justify-between mb-10 md:mb-12">
          <div>
            <h1 className="font-serif text-4xl md:text-5xl font-light mb-3 tracking-tight">My Wishlist</h1>
        ...
        {isLoading || loadingProducts ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-16 text-center shadow-sm">
            ...
            <h2 className="font-serif text-3xl font-light mb-3 tracking-tight">Your wishlist is empty</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
            {products.map((product) => (
              <div
                ...
                className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 relative group"
              >
                {/* Remove from wishlist button */}
                <button
                  onClick={() => handleRemove(product.product_id)}
                  className="absolute top-3 right-3 z-10 p-2.5 rounded-full bg-white/90 backdrop-blur-md shadow-lg hover:bg-white hover:scale-110 transition-all duration-300"
                ...
                <Link href={`/products/${product.slug}`}>
                  <div className="h-64 w-full bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center overflow-hidden group-hover:bg-gradient-to-br group-hover:from-gray-100 group-hover:to-gray-50 transition-all duration-300">
                    <Image
                  ...
                  <div className="p-5">
                    <h4 className="font-medium text-base font-serif mb-2 group-hover:text-[#D4AF37] transition-colors">
                      {product.title}
                    </h4>
