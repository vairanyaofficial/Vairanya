    ...
    <div className="min-h-screen bg-[#FAF9F6] dark:bg-black">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-12 text-center">
          <h1 className="font-serif text-4xl md:text-5xl mb-4 dark:text-white">Terms & Conditions</h1>
          <p className="text-gray-600 dark:text-gray-400">Last updated: {new Date().toLocaleDateString()}</p>
        </div>

        <div className="bg-white dark:bg-[#0a0a0a] rounded-lg p-8 shadow-sm dark:shadow-none border border-gray-200/50 dark:border-white/10 space-y-8">
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Agreement to Terms</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Products and Pricing</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Orders and Payment</h2>
            <div className="space-y-4 text-gray-700 dark:text-gray-300">
              <p>
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Shipping and Delivery</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Returns and Refunds</h2>
            <p className="text-gray-700 dark:text-gray-300">
              Please refer to our{" "}
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Intellectual Property</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Limitation of Liability</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Governing Law</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Changes to Terms</h2>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <section>
            <h2 className="font-serif text-2xl mb-4 dark:text-white">Contact Information</h2>
            <p className="text-gray-700 dark:text-gray-300">
